...
void MenuState::onClick(MyGUI::Widget* sender) {
    ...
    if (sender->getName() == "Gui.multi_player_button") {
        ...
        dt::StateManager::get()->setNewState(new AnimationState("videos/begin.avi", 36, new BattleState("01")));
        ...
        dt::StateManager::get()->setNewState(new AnimationState("videos/credits.avi", 36, new MenuState()));
